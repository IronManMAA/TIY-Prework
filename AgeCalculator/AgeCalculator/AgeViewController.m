...
- (void)viewDidLoad
{
    ...
    //<#based on the pattern with the first two, what goes here?#>;
...
- (IBAction)birthdateSelected:(UIDatePicker *)sender
{
    ...
    // <#how do we call the above method here?#>];
    ...
    //<#what's the name of the method that determines their next birthday?#>];
...
- (void)configureCurrentDateLabel
{
    ...
    //<#which property of the UILabel should we be setting here?#> = <#Can we just put the today variable here?#>;
}
